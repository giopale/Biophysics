...
The potassium transfer through the cell membrane is regulated by different kind of channels; among these one special mention goes to the BK channels, which are large conductance calcium-activated potassium channels, hence the name, which stands for \emph{big potassium}. %which has the property of being activated by the joint action of depolarization and $\text{Ca}^{2+}.$
